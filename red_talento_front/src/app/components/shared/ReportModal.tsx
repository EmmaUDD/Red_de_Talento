...
export function ReportModal({ targetName, targetType, postId, targetId, onClose }: ReportModalProps) {
          ...
          {sent ? (
            <div className="p-8 text-center">
              ...
              <p className="text-slate-500 text-xs mt-1">
                El equipo del Liceo revisará el caso y tomará las medidas correspondientes.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Describe con detalle los hechos que estás reportando..."
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-lg text-sm flex items-center justify-center gap-2 transition-colors ${canSubmit && !sending ? "bg-red-500 hover:bg-red-600 text-white" : "bg-slate-100 text-slate-400 cursor-not-allowed"}`}
